...
AZURE_CONTAINER_STATIC = os.environ.get("AZURE_CONTAINER_STATIC")
AZURE_CONTAINER_MEDIA = os.environ.get("AZURE_CONTAINER_MEDIA")
...
ACCOUNT_RATE_LIMITS = {
    'login_failed': '5/300s',  # Limit login attempts to 5 within 300 seconds (5 minutes)
}
