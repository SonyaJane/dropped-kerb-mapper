...
<img src="readme-files/html_validator_errors_corrected.png" alt="Home page validation errors corrected" style="width:600px;">
...
<img src="readme-files/hidden_form_control_error.png" alt="Hidden form control errors image" style="width:600px;">
...
<img src="readme-files/css_validator_error.png" alt="CSS validation image" style="width:600px;">
...
| --- | --- |
| ./mapper/admin_forms.py | None |
| ./mapper/admin.py | ![admin.py linter results image](/readme-files/python_linter_admin.png) |
| ./mapper/filters.py | ![filters.py linter results image](/readme-files/python_linter_admin.png) |
| ./mapper/forms.py | ![forms.py linter results image](/readme-files/python_linter_forms.png) |
| ./mapper/models.py | ![models.py linter results image](/readme-files/python_linter_models.png) |
| ./mapper/signals.py | ![signals.py linter results image](/readme-files/python_linter_signals.png) |
| ./mapper/tables.py | ![tables.py linter results image](/readme-files/python_linter_tables.png) |
| ./mapper/urls.py | None |
| ./mapper/utils.py | ![utils.py linter results image](/readme-files/python_linter_utils.png) |
| ./mapper/views.py | ![views.py linter results image](/readme-files/python_linter_views.png) |
